...
import com.maris7.guard.raytraceantixray.data.MutableLongWrapper;
...
import com.maris7.guard.raytraceantixray.util.BlockIterator;
import com.maris7.guard.raytraceantixray.util.BlockOcclusionCulling;
import com.maris7.guard.raytraceantixray.util.BlockOcclusionCulling.BlockOcclusionGetter;
...
public final class RayTraceCallable implements Callable<Void> {
    ...
    public RayTraceCallable(MarisGuard plugin, PlayerData playerData) {
        this.plugin = plugin;
        ...
        cachedSectionBlockOcclusionGetter = new CachedSectionBlockOcclusionGetter() {
            ...
            public boolean isOccluding(int x, int y, int z) {
                ...
                if (this.chunkX != chunkX || this.chunkZ != chunkZ) {
                    mutableLongWrapper.setValue(ChunkKeyUtil.asLong(chunkX, chunkZ));
